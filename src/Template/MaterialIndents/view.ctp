<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Material Indent'), ['action' => 'edit', $materialIndent->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Material Indent'), ['action' => 'delete', $materialIndent->id], ['confirm' => __('Are you sure you want to delete # {0}?', $materialIndent->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Material Indents'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Material Indent'), ['action' => 'add']) ?> </li>
