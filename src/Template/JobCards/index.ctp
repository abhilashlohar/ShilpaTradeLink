...
<div class="caption">
	...
	<span class="caption-subject font-blue-steel uppercase">Quotation</span> 
</div>
		...
		<div class="col-md-12">
		    ...
		    <?php foreach ($jobCards as $jobCards): ?>
				<tr>
					...
					<?php echo $this->Html->link('<i class="fa fa-search"></i>',['action' => 'view', $jobCards->id],array('escape'=>false,'class'=>'btn btn-xs yellow tooltips','data-original-title'=>'View')); ?>
