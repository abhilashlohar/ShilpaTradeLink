...
<div class="portlet light bordered">
	...
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		 <?= $this->Form->create($contraVoucher,['type' => 'file','id'=>'form_sample_3']) ?>
			<div class="form-body">
			<div class="row">
				<div class="col-md-9">
				</div>
			...
			<div class="row" style="margin-top:30px;">
				<div class="col-md-4" >
						...
						<label class=" control-label">Transaction Date<span class="required" aria-required="true">*</span></label>
							<?php echo $this->Form->input('transaction_date', ['type' => 'text','label' => false,'class' => 'form-control input-sm date-picker','data-date-format' => 'dd-mm-yyyy','value' => date("d-m-Y",strtotime($contraVoucher->transaction_date))]); ?>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<?php echo $this->Form->input('cash_bank_from', ['empty'=>'--Select-','label' => false,'class' => 'form-control input-sm select2me']); ?>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<?php echo $this->Form->input('cash_bank_to', ['empty'=>'--Select-','label' => false,'class' => 'form-control input-sm select2me']); ?>
			...
			<div class="form-actions">
				<button type="submit" class="btn btn-primary">UPDATE CONTRA VOUCHER</button>
			</div>
		</div>
		<?= $this->Form->end() ?>
		<!-- END FORM-->
