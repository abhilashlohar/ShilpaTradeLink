...
<table width="100%" class="divHeader">
		<tr>
			<td width="50%"><?php echo $this->Html->image('/logos/'.$creditNote->company->logo, ['width' => '40%']); ?></td>
			<td align="right" width="50%" style="font-size: 12px;">
			<span style="font-size: 14px;"><?= h($creditNote->company->name) ?></span><br/>
			<span><?= $this->Text->autoParagraph(h($creditNote->company->address)) ?></span>
			<span><?= h($creditNote->company->mobile_no) ?></span>
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<div align="center" style="font-size: 16px;font-weight: bold;color: #0685a8;">CREDIT NOTE</div>
		...
		<tr>
			...
			<td align="right">
				<table>
					<tr>
						<td align="center">
						For <?= h($creditNote->company->name) ?><br/><br/><br/><span style="    border-top: solid 1px #585757;">Authorised Signatory</span>
						</td>
					</tr>
				</table>
			</td>
