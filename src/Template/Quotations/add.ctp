			...
			<table class="table tableitm" id="main_tb">
				...
				<tbody id="main_tbody">
					...
					<tr class="tr1" row_no='<?php echo @$quotation_rows->id; ?>'>
							...
							<td><?php echo $this->Form->input('quotation_rows.'.$q.'.rate', ['type'=>'number','label' => false,'class' => 'form-control input-sm quantity','placeholder'=>'Rate', 'min'=>'0.01','value' => @$quotation_rows->rate]); ?></td>
